...
class StatCsvProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterVectorLayer('addresslayer', 'Address Layer', types=[QgsProcessing.TypeVectorPolygon], defaultValue=None))
        self.addParameter(QgsProcessingParameterField('addressfield', 'Address Field', type=QgsProcessingParameterField.String, parentLayerParameterName='addresslayer', allowMultiple=False, defaultValue=None))
        ...
        self.addParameter(QgsProcessingParameterVectorDestination('GeojsonOutput', 'geojson output', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, defaultValue=None))
